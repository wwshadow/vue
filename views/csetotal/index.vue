      ...
      <el-col :span="24" style="margin-top: 20px">
        <el-card shadow="hover">
          <el-table :data="tableData" border style="width: 100%">
            <el-table-column prop="date" label="cseID" width="180">
            </el-table-column>
            <el-table-column prop="name" label="cse名称" width="180">
            </el-table-column>
            <el-table-column prop="address" label="cse状态" width="180">
            </el-table-column>
            <el-table-column prop="address" label="客户组织名称" width="180">
            </el-table-column>
            <el-table-column prop="address" label="客户名称" width="180">
            </el-table-column>
            <el-table-column prop="address" label="项目名称" width="180">
            </el-table-column>
            <el-table-column prop="address" label="当前版本" width="180">
            </el-table-column>
            <el-table-column prop="address" label="维保到期时间" width="180">
            </el-table-column>
            <el-table-column prop="address" label="部署形态">
            </el-table-column>
          </el-table>
        </el-card>
      </el-col>
